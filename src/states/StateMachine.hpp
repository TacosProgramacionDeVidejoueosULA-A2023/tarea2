...
public:
    ...
    void change_state(const std::string& state_name, std::shared_ptr<World> world = nullptr, std::shared_ptr<Bird> bird = nullptr, std::shared_ptr<BaseGameMode> mode = nullptr) noexcept;
