...
void StateMachine::change_state(const std::string& state_name, std::shared_ptr<World> world, std::shared_ptr<Bird> bird, std::shared_ptr<BaseGameMode> mode) noexcept
{
    ...
    current_state->enter(world, bird, mode);
}
