...
struct Settings
{
    ...
    static constexpr float LOGS_GAP{130.f};
    ...
    static constexpr float BIRD_SPEED{MAIN_SCROLL_SPEED * 25.f};
    ...
    static constexpr float POWERUP_TIME_PERIOD{8.f};
    static constexpr float TIME_TO_SPAWN_POWERUP{7.f};
    static constexpr float POWER_WIDTH{27.f};
    static constexpr float POWER_HEIGHT{27.f};
